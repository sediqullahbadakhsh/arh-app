...
import { activateGameByAgent, checkGameOrderStatus } from "../../services/merchantApi";
...
export default function GameActivationMerchantScreen({ navigation, route }) {
  ...
  const activateGame = async () => {
    ...
    try {
      ...
      const response = await activateGameByAgent(payload);
  ...
  const getStatusMessage = () => {
    switch (orderStatus) {
      case ORDER_STATUS.QUEUED:
        return "Your game activation request has been submitted. Our system will activate your game coins shortly.";
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.inputSection}>
          ...
          <TextInput
            style={styles.input}
            placeholder={t("enterPlayerId") || "Enter player ID"}
