...
import { 
  activateSocialProductByCustomer,
...
export default function SocialActivationCustomerScreen({ navigation, route }) {
  ...
  const activateSocialProduct = async () => {
    ...
    try {
      ...
      const response = await activateSocialProductByCustomer(payload);
  ...
  const getStatusMessage = () => {
    switch (orderStatus) {
      case ORDER_STATUS.PENDING:
        return "Your social activation request has been submitted and payment processed. Our system will process your request shortly.";
      ...
      >
        ...
        {/* <View style={styles.productCard}>
          ...
          <Text style={styles.productDescription}>
            {product?.description || "Social product activation"}
          </Text>
        ...
        <View style={styles.inputSection}>
          ...
          <TextInput
            style={styles.input}
            placeholder={t("enterSocialId") || "Enter your social ID or username"}
